        ...
        if not input_produk or not input_deskripsi:
            ...
            with st.spinner("Memindai tren bahasa Jaksel, Gen-Z, dan memverifikasi keamanan HAKI & filter non-SARA di kepala AI..."):
                ...
                if error:
                    ...
                    # DISCLAIMER HUKUM DITAMBAHKAN DI SINI
                    st.warning("⚠️ **DISCLAIMER HUKUM:** Ide nama dan slogan di atas murni hasil penalaran Artificial Intelligence (AI) dan **bukan pengecekan hukum resmi**. Sebelum menggunakan atau mendaftarkan merek, Anda wajib melakukan verifikasi mandiri ke Pangkalan Data Kekayaan Intelektual (PDKI) Kemenkumham RI.")